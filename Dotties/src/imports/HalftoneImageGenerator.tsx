import svgPaths from "./svg-2pfu3jgetd";
  ...
  return (
    <div className="h-[15.994px] relative shrink-0 w-[29.072px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[15.994px] relative w-[29.072px]">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.68px] tracking-[0.6px] uppercase whitespace-pre">Edit</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[15.994px] relative shrink-0 w-[84.945px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[15.994px] relative w-[84.945px]">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.68px] tracking-[0.6px] uppercase whitespace-pre">Parameters</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[25.332px] relative shrink-0 w-[69.342px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[25.332px] relative w-[69.342px]">
        <Icon3 />
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[45.16px] not-italic text-[#4a5565] text-[12px] text-center text-nowrap top-[5.35px] translate-x-[-50%] whitespace-pre">Reset</p>
      </div>
    </div>
  );
}
...
function Label() {
  return (
    <div className="h-[19.987px] relative shrink-0 w-full" data-name="Label">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] text-nowrap top-[0.35px] tracking-[-0.1504px] whitespace-pre">Processing Method</p>
    </div>
  );
}
  ...
  return (
    <div className="basis-0 bg-[rgba(255,255,255,0.05)] grow h-[35.981px] min-h-px min-w-px relative shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[35.981px] relative w-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[88.08px] not-italic text-[#d1d5dc] text-[14px] text-center text-nowrap top-[8.35px] tracking-[-0.1504px] translate-x-[-50%] whitespace-pre">Halftone</p>
      </div>
    </div>
  );
}
...
function Button5() {
  return (
    <div className="basis-0 grow h-[35.981px] min-h-px min-w-px relative shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[35.981px] relative w-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[88.95px] not-italic text-[#4a5565] text-[14px] text-center text-nowrap top-[8.35px] tracking-[-0.1504px] translate-x-[-50%] whitespace-pre">Ordered</p>
      </div>
    </div>
  );
}
...
function Label1() {
  return (
    <div className="h-[19.987px] relative shrink-0 w-full" data-name="Label">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] text-nowrap top-[0.35px] tracking-[-0.1504px] whitespace-pre">Dot Shape</p>
    </div>
  );
}
...
function Button6() {
  return (
    <div className="basis-0 bg-[rgba(255,255,255,0.05)] grow h-[35.981px] min-h-px min-w-px relative shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[35.981px] relative w-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[89.01px] not-italic text-[#d1d5dc] text-[14px] text-center text-nowrap top-[8.35px] tracking-[-0.1504px] translate-x-[-50%] whitespace-pre">Circle</p>
      </div>
    </div>
  );
}
...
function Button7() {
  return (
    <div className="basis-0 grow h-[35.981px] min-h-px min-w-px relative shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[35.981px] relative w-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[88.76px] not-italic text-[#4a5565] text-[14px] text-center text-nowrap top-[8.35px] tracking-[-0.1504px] translate-x-[-50%] whitespace-pre">Square</p>
      </div>
    </div>
  );
}
...
function Label2() {
  return (
    <div className="h-[19.987px] relative shrink-0 w-full" data-name="Label">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] text-nowrap top-[0.35px] tracking-[-0.1504px] whitespace-pre">Dot Color</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[15.994px] relative shrink-0 w-[50.549px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[15.994px] relative w-[50.549px]">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.68px] uppercase whitespace-pre">#ffffff</p>
      </div>
    </div>
  );
}
...
function Label4() {
  return (
    <div className="h-[19.987px] relative shrink-0 w-full" data-name="Label">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] text-nowrap top-[0.35px] tracking-[-0.1504px] whitespace-pre">BG Color</p>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="h-[15.994px] relative shrink-0 w-[50.549px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[15.994px] relative w-[50.549px]">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.68px] uppercase whitespace-pre">#0a0a0a</p>
      </div>
    </div>
  );
}
...
function Label6() {
  return (
    <div className="absolute h-[19.987px] left-0 top-0 w-[100.506px]" data-name="Label">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] text-nowrap top-[0.35px] tracking-[-0.1504px] whitespace-pre">Transparent BG</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[19.987px] relative shrink-0 w-[53.971px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[19.987px] relative w-[53.971px]">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] text-nowrap top-[0.35px] tracking-[-0.1504px] whitespace-pre">Dot Size</p>
      </div>
    </div>
  );
}
...
function Container35() {
  return <div className="absolute bg-[rgba(255,255,255,0.15)] h-[3.993px] left-0 top-0 w-[49.925px]" data-name="Container" />;
}

function Container36() {
  return <div className="absolute bg-[#6a7282] border-[0.676px] border-[rgba(255,255,255,0.08)] border-solid left-[43.93px] size-[11.99px] top-[-4px]" data-name="Container" />;
}
  ...
  return (
    <div className="h-[19.987px] relative shrink-0 w-[52.123px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[19.987px] relative w-[52.123px]">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] text-nowrap top-[0.35px] tracking-[-0.1504px] whitespace-pre">Spacing</p>
      </div>
    </div>
  );
}
...
function Container40() {
  return <div className="absolute bg-[#6a7282] border-[0.676px] border-[rgba(255,255,255,0.08)] border-solid left-[28.95px] size-[11.99px] top-[-4px]" data-name="Container" />;
}
  ...
  return (
    <div className="h-[19.987px] relative shrink-0 w-[55.736px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[19.987px] relative w-[55.736px]">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] text-nowrap top-[0.35px] tracking-[-0.1504px] whitespace-pre">Contrast</p>
      </div>
    </div>
  );
}
...
function Button8() {
  return (
    <div className="basis-0 grow h-[47.992px] min-h-px min-w-px relative shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[47.992px] relative w-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[98.58px] not-italic text-[#4a5565] text-[14px] text-center text-nowrap top-[14.35px] tracking-[-0.1504px] translate-x-[-50%] whitespace-pre">Upload</p>
      </div>
    </div>
  );
}
...
function Container64() {
  return (
    <div className="bg-[rgba(255,255,255,0.08)] h-[47.992px] relative shrink-0 w-[0.993px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[47.992px] w-[0.993px]" />
    </div>
  );
}
...
function Button9() {
  return (
    <div className="basis-0 bg-[rgba(255,255,255,0.05)] grow h-[47.992px] min-h-px min-w-px relative shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[47.992px] relative w-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[97.68px] not-italic text-[#d1d5dc] text-[14px] text-center text-nowrap top-[14.35px] tracking-[-0.1504px] translate-x-[-50%] whitespace-pre">Edit</p>
      </div>
    </div>
  );
}

function MobileControls1() {
  return (
    <div className="absolute bg-neutral-950 content-stretch flex h-[47.992px] items-start left-0 top-[803.89px] w-[393.488px]" data-name="MobileControls">
      <div aria-hidden="true" className="absolute border-[0.676px_0px_0px] border-black border-solid inset-0 pointer-events-none" />
      <Button8 />
      <Container64 />
      <Button9 />
    </div>
