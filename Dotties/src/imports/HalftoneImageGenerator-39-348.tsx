import svgPaths from "./svg-tqwf4yomgy";
  ...
  return (
    <div className="basis-0 bg-[#222222] grow h-full min-h-px min-w-px relative shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[calc(50%+0.41px)] not-italic text-[#d1d5dc] text-[14px] text-center text-nowrap top-[calc(50%-11px)] tracking-[-0.1504px] translate-x-[-50%] whitespace-pre">Upload</p>
      </div>
    </div>
  );
}
...
function Button9() {
  return (
    <div className="basis-0 grow h-full min-h-px min-w-px relative shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[calc(50%+0.08px)] not-italic text-[#4a5565] text-[14px] text-center text-nowrap top-[calc(50%-11px)] tracking-[-0.1504px] translate-x-[-50%] whitespace-pre">Edit</p>
      </div>
    </div>
  );
}
