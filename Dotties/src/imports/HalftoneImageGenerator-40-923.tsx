import svgPaths from "./svg-ockgehgfqt";
...
function Heading() {
  return (
    <div className="absolute h-[36.002px] left-[47.98px] top-0 w-[76.409px]" data-name="Heading 1">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] leading-[36px] left-0 not-italic text-[#d1d5dc] text-[14px] text-nowrap top-[0.06px] tracking-[0.0703px] whitespace-pre">Dotties</p>
    </div>
  );
}
